...
for (int i = 1; i <= testData.getRowNumbers(); i++) {
	...
	WebUI.delay(2)
    WebUI.navigateToUrl('http://13.228.241.164:8081/hrp2/self_medicalclaimnewwf_newentry.jsp?newdate=03/05/202410:30:23&reqstaffno=' + staffnumber)
	...
	def testData1 = findTestData('Medical')
