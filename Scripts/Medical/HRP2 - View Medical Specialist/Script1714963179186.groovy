...
for(int i=1; i <= credentialsData.getRowNumbers(); i++ ) {
	...
	println(TAG + "Navigate to Medicacl Specialist Page") // Debug statement
	
	WebUI.navigateToUrl(hosturl + 'listselfservice_medicalspecialist.jsp')
