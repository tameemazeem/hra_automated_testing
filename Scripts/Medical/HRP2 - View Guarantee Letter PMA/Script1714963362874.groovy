...
String TAG = "GUARANTEE LETTER PMA: "
...
for(int i=1; i <= credentialsData.getRowNumbers(); i++ ) {
	...
	println(TAG + "Navigate to Guarntee Letter PMA Page") // Debug statement
	
	WebUI.navigateToUrl(hosturl + 'selflist_guaranteeletterwf.jsp')
