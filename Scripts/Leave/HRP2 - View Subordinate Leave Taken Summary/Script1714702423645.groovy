...
for (int i = 1; i <= testData.getRowNumbers(); i++) {
	...
	WebUI.navigateToUrl('http://13.228.241.164:8081/hrp2/selflist_summary_leave_taken.jsp?')
	WebUI.delay(2)
	
	WebUI.executeJavaScript('document.getElementById(\'submitBtn\').click();', null)
